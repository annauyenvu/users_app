...
class _SearchDestinationPageState extends State<SearchDestinationPage> {
  ...
  searchLocation(String locationName) async {
    if(locationName.length>1) {
      String apiPlaceUrl = "https://maps.googleapis.com/maps/api/place/autocomplete/json?input=$locationName&key=$googleMapKey&components=country:vn";
                                ...
                                child: Padding(
                                  ...
                                  child: TextField(
                                    ...
                                    decoration: const InputDecoration(
                                      ...
                                      isDense: true,
                                      contentPadding: EdgeInsets.only(left: 11, bottom: 9,),
                                    ),
                                  ),
                                ),
                              ),
